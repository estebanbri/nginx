...
- PAT (Port Address Translation): Mapea cada IP Privada a unica IP Publica + Numero puerto generado por el router (https://www.youtube.com/watch?v=iT6Ey8V83rY)
- Port Fordwarding (Explicado arriba)
