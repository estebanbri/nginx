...
- PAT DINAMICO (Port Address Translation): Deals with OUTGOING traffic to the Internet. Traduce cada (IP Privada + Puerto) a una unica (IP publica + *Puerto dinamico) *generado por el router (https://www.youtube.com/watch?v=iT6Ey8V83rY)
- PAT ESTATICO (Port Fordwarding) Deals with INCOMING traffic from Internet. Dada una unica (IP publica + Puerto) la traduce a una unica (IP Privada + Numero puerto fijo*) (Explicado arriba)
